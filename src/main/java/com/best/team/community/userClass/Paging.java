...
public class Paging {
    ...
    public Paging(int maxNum, int pageNum, int listCount, int pageCount, String boardType) {
        this.maxNum = maxNum;
    ...
    public String makeHtmlPaging() {
        ...
        return makeHtml(currentGroup, totalPage, boardType);
    }

    private String makeHtml(int currentGroup, int totalPage, String boardType) {
